module.exports = {
	...
	"updated_at": "2020-08-06T21:49:56Z",
	"source_locale": {
	...
	"keys": {
		...
		"addCustomDomainUsers_msg": "أضف مستخدمين جددًا أو قم بتحرير الأسماء المستعارة للبريد الإلكتروني للمستخدمين الحاليين إذا كنت بحاجة إلى عناوين بريد إلكتروني لأشخاص آخرين.",
		"addCustomDomainValidationRecord_msg": "الرجاء إضافة سجل TXT لنطاقك لإثبات ملكيتك كما هو موضح أدناه:",
		...
		"bookingItemUsersIncluding_label": "المستخدمين المدرجين :",
		...
		"calendarShareCapabilityInvite_label": "كتابة وإدارة المشاركة",
		"calendarShareCapabilityRead_label": "مقروء فقط",
		"calendarShareCapabilityWrite_label": "القراءة و الكتابة",
		...
		"creditCardDeclined_msg": "للأسف ، تم رفض بطاقة الائتمان الخاصة بك. يرجى الاتصال بالمصرف الذي تتعامل معه لحل هذه المشكلة أو تحديد طريقة دفع مختلفة.",
		...
		"deletionWarning_msg": "لأسباب تتعلق بالخصوصية ، سيتم حذف الحسابات المجانية إذا لم يتم استخدامها لأكثر من ستة أشهر. ومع ذلك ، لا يتم أبدًا حذف حسابات المستخدمين الذين يدفعون. اقرأ المزيد عما تحصل عليه من خلال اشتراكاتنا المدفوعة:",
		...
		"enterDomainFieldHelp_label": "بالنسبة إلى موقع ويب مثل www.example.com ، يكون المجال الرئيسي هو example.com.",
		...
		"enterDomain_msg": "ابدأ بإدخال المجال الرئيسي الخاص بك.",
		...
		"inactiveAccount_msg": "تم إغلاق حسابك لأنك لم تقم بتسجيل الدخول خلال الأشهر الستة الماضية. انظر هنا لمزيد من المعلومات:",
		...
		"invitationMailSubject_msg": "هذا عنوان بريدي الإلكتروني الجديد - انضم إلى توتانوتا حتى نتمكن من استعادة خصوصيتنا",
		...
		"mailAuthFailed_msg": "قد تكون الرسالة مزورة. لا تثق بمحتويات هذه الرسالة لأن عنوان المرسل أو محتويات البريد قد تكون مزيفة!",
		...
		"maybe_label": "ربما ",
		"mayNotWorkForAllDe_msg": "قد لا يعمل هذا في جميع بيئات سطح المكتب لاينكس.",
		...
		"payCardContactBankError_msg": "تم رفض معاملة الدفع من قبل البنك الذي تتعامل معه. يرجى الاتصال بالبنك الذي تتعامل معه.",
		"payCardExpiredError_msg": "انتهت صلاحية بطاقة الائتمان. يرجى تحديث تفاصيل الدفع الخاصة بك.",
		"payCardInsufficientFundsError_msg": "تم رفض معاملة الدفع بسبب عدم كفاية الأموال.",
		"payChangeError_msg": "فشلت عملية الدفع. الدفع باستخدام بالبيانات المقدمة غير ممكن. يرجى تغيير بيانات الدفع الخاصة بك.",
		"payContactUsError_msg": "فشلت عملية الدفع. الرجاء التواصل معنا.",
		...
		"payPaypalChangeSourceError_msg": "فشلت عملية الدفع. يرجى اختيار طريقة مختلفة للدفع في PayPal.",
		"payPaypalConfirmAgainError_msg": "فشلت عملية الدفع. يرجى تحديث وتأكيد تفاصيل الدفع الخاصة بك.",
		"pending_label": "معلق ",
		...
		"phishingMessageBody_msg": "تشبه الرسائل الأخرى التي تم الإبلاغ عنها بشأن التصيد.",
		...
		"sendUpdates_msg": "إرسال التحديثات؟",
		"send_action": "إرسال",
		...
		"sharingFeatureNotOrderedUser_msg": "لمشاركة التقويم ، يجب عليك طلب ميزة المشاركة. يرجى الاتصال بالمسؤول.",
		"sharingFeature_label": "مشاركة",
		...
		"showTrayIcon_action": "عرض رمز العلبة ",
		...
		"unsubscribeConfirm_msg": "هل تريد حقًا إيقاف اشتراكك؟ سيتم إعادة تعيين حسابك إلى Free (مجانا) الآن وستفقد على الفور ميزاتك المدفوعة.",
		...
		"upgradeTeams_msg": "سيتم ترقية اشتراكك إلى فرق (Teams).",
